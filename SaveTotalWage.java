public class SaveTotalWage {
    ...
    public SaveTotalWage(String company, int wagePerHour, int maxWorkingHours, int maxWorkingDays) {
    ...
    public static void main(String[] args) {
        SaveTotalWage google = new SaveTotalWage("Google", 40, 80, 20);
        google.computeWage();
        System.out.println(google);
        System.out.println();
        SaveTotalWage microsoft = new SaveTotalWage("Microsoft", 35, 90, 22);
